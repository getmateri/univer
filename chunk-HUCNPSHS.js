...
function BatchSaveImagesDialog() {
  ...
  const [fileNameParts, setFileNameParts] = (0, import_react8.useState)(["cellAddress" /* CELL_ADDRESS */]);
  const [saving, setSaving] = (0, import_react8.useState)(false);
  const [error, setError] = (0, import_react8.useState)(null);
  const images = (0, import_react8.useMemo)(() => batchSaveService.getCellImagesInSelection(), [batchSaveService]);
  const dataColumns = (0, import_react8.useMemo)(() => batchSaveService.getDataColumns(), [batchSaveService]);
  const rowRange = (0, import_react8.useMemo)(() => batchSaveService.getSelectionRowRange(), [batchSaveService]);
  ...
  const [selectedColumn, setSelectedColumn] = (0, import_react8.useState)(
    () => columnOptions.length > 0 ? columnOptions[0].value : "0"
  );
  const highlightRanges = (0, import_react8.useMemo)(() => {
  ...
  const handleFileNamePartsChange = (0, import_react8.useCallback)((value) => {
    if (value.length === 0) {
      return;
    }
    setFileNameParts(value);
  }, []);
  const handleColumnChange = (0, import_react8.useCallback)((value) => {
  ...
  const handleConfirm = (0, import_react8.useCallback)(async () => {
    if (images.length === 0) {
      return;
    }
    setSaving(true);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "univer-flex univer-flex-col", children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(FormLayout, { label: localeService.t("sheets-drawing-ui.save.imageCount"), children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "univer-text-sm univer-text-gray-600", children: images.length }) }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(FormLayout, { label: localeService.t("sheets-drawing-ui.save.fileNameConfig"), children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(CheckboxGroup, { value: fileNameParts, onChange: handleFileNamePartsChange, direction: "vertical", children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Checkbox, { value: "cellAddress" /* CELL_ADDRESS */, disabled: !hasAvailableColumns, children: localeService.t("sheets-drawing-ui.save.useRowCol") }),
      hasAvailableColumns && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Checkbox, { value: "columnValue" /* COLUMN_VALUE */, children: localeService.t("sheets-drawing-ui.save.useColumnValue") })
    ] }) }),
    showColumnSelect && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(FormLayout, { label: localeService.t("sheets-drawing-ui.save.selectColumn"), children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
      Select,
      {
    ...
    error && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "univer-text-xs univer-text-red-500", children: error }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
      "div",
      {
        className: `univer-flex univer-justify-end univer-gap-2 univer-border-t univer-border-gray-200 univer-pt-3`,
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Button, { onClick: handleCancel, disabled: saving, children: localeService.t("sheets-drawing-ui.save.cancel") }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
          ...
          {
            className: `univer-text-gray-600 dark:!univer-text-gray-200`,
            children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { children: localeService.t("sheets-drawing-ui.drawing-anchor.title") })
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(RadioGroup, { value, onChange: handleChange, direction: "vertical", children: [
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Radio, { value: "1" /* Both */, children: localeService.t("sheets-drawing-ui.drawing-anchor.both") }),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Radio, { value: "0" /* Position */, children: localeService.t("sheets-drawing-ui.drawing-anchor.position") }),
          /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Radio, { value: "2" /* None */, children: localeService.t("sheets-drawing-ui.drawing-anchor.none") })
        ] }) })
      ]
    }
  );
...
var SheetDrawingPanel = () => {
  ...
  return !!(drawings == null ? void 0 : drawings.length) && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "univer-text-sm", children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(DrawingCommonPanel, { drawings }),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(SheetDrawingAnchor, { drawings })
  ] });
};
...
var PrintingFloatDom = (props) => {
  ...
  const floatDomParams = (0, import_react11.useMemo)(() => floatDomInfos.map((info) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { style: { position: "absolute", top: 0, left: 0 }, children: floatDomParams.map(([id, floatDom]) => /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(PrintFloatDomSingle, { layer: floatDom, id, position: floatDom.position }, id)) });
};
function mountPrintingFloatDom(props, root, injector) {
  ...
  render(/* @__PURE__ */ (0, import_jsx_runtime11.jsx)(PrintingFloatDomInjector, { ...props }), root);
  return () => unmount(root);
}
